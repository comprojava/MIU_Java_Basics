...
public class TestStudent {
	public static void main(String[] args) {
		...
		/*
		 * 2. Anonymous Implementation for sorting student list using Score Without any
		 * class do the direct implementation of Comparator Interface
		 */
...
//	  //5. Comparator consist with equals.
	  ...
	  Student st2 = new Student("Tim",1234,50);
	  
	  boolean res = st1.equals(st2); // false
	  System.out.println(res); 
	  int res1=id.compare(st1, st2);
